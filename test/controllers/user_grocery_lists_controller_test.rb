...
class UserGroceryListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_grocery_list" do
    assert_difference('UserGroceryList.count') do
      post user_grocery_lists_url, params: { user_grocery_list: { grocery_list_id: @user_grocery_list.grocery_list_id, user_id: @user_grocery_list.user_id } }
    end
  ...
  test "should update user_grocery_list" do
    patch user_grocery_list_url(@user_grocery_list), params: { user_grocery_list: { grocery_list_id: @user_grocery_list.grocery_list_id, user_id: @user_grocery_list.user_id } }
