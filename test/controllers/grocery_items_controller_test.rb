...
class GroceryItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grocery_item" do
    assert_difference('GroceryItem.count') do
      post grocery_items_url, params: { grocery_item: { active: @grocery_item.active, amount: @grocery_item.amount, grocery_list_id: @grocery_item.grocery_list_id, name: @grocery_item.name, user_id: @grocery_item.user_id } }
    end
  ...
  test "should update grocery_item" do
    patch grocery_item_url(@grocery_item), params: { grocery_item: { active: @grocery_item.active, amount: @grocery_item.amount, grocery_list_id: @grocery_item.grocery_list_id, name: @grocery_item.name, user_id: @grocery_item.user_id } }
